...
const upload = require('../../middlewares/logo.js');
...
router.post('/company/request-access', loginLimiter, upload.single('logo'), validate(requestAccessCompanyRules), authController.requestAccessCompany);
